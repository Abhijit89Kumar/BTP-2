...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.85\textwidth]{scaling_sweep.png}
\end{center}
\vspace{-0.3cm}
\begin{columns}[T]
\begin{column}{0.48\textwidth}
\begin{block}{\small Speedup peaks at moderate $N$}
\footnotesize
At large $N$ the matmul dominates and both backends converge. Extension kernels (more work per tile) achieve 1.3--1.7$\times$ at all scales.
\end{block}
\end{column}
\begin{column}{0.48\textwidth}
\begin{block}{\small Memory savings grow with $N$}
\footnotesize
$\mathbf{D}[N,S]$ grows as $N{\times}S$: savings increase from 2.9\% ($N{=}128$) to 24.5\% ($N{=}2048$). At full scale ($S{=}131\text{K}$): \textbf{49.4\%}.
\end{block}
\end{column}
\end{columns}
\end{frame}
...
\end{columns}
\vspace{-0.3em}
\begin{block}{\small Key Findings}
\footnotesize
\begin{itemize}\setlength\itemsep{0.05em}
    \item 78\% of products should order below $\mu$ (mean $Q^*/\mu = 0.854$)
    \item Aggregate profit improvement: \highlight{+5.3\%}
...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.92\textwidth]{cvar_vs_eprofit_scatter.png}
\end{center}
\end{column}
\begin{column}{0.48\textwidth}
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.92\textwidth]{cvar_risk_gap_generators.png}
\end{center}
\end{column}
\end{columns}
\vspace{-0.3em}
...
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.92\textwidth]{budget_bisection_convergence.png}
\end{center}
\end{column}
\begin{column}{0.48\textwidth}
\vspace{-0.3cm}
\begin{center}
\includegraphics[width=0.92\textwidth]{sub_boxplot_generators.png}
\end{center}
\end{column}
\end{columns}
\vspace{-0.3em}
...
\small
\begin{itemize}\setlength\itemsep{0.1em}
    \item \textbf{Budget:} converges in 13 iterations, $\lambda^*{=}0.1575$, profit loss $-30.7\%$
    \item \textbf{Substitution:} \highlight{+10.3\%} aggregate profit; all 2,048 products benefit
\end{itemize}
\end{block}
\end{frame}
